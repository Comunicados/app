			...
			<div class="login-wrap">
				...
				<img src="assets/img/login-logo.png" class="logo">
					<form role="form" action="index.html">
						...
						<input type="text" class="form-control text-input" placeholder="Número de Documento">
						</div>
						<div class="form-group login-input">
						<i class="fa fa-key overlay"></i>
						<input type="password" class="form-control text-input" placeholder="********">
						</div>
						<div class="checkbox"><label><input type="checkbox" class="form-control"> Acepto los <strong><a href='#'>Términos y Condiciones</a></strong></label></div>
						<div class="row">
							<div class="col-sm-12">
